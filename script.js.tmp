...
const DISCIPLINAS = [
  ...
  { id:"logica-de-programacao", num:"02", name:"Lógica de Programação",
    ...
    lessonsCount: 12 },
  { id:"fundamentos-de-redes", num:"03", name:"Fundamentos de Redes de Computadores",
    desc:"Conceitos, topologias, meios de transmissão, modelos OSI e TCP/IP, endereçamento IP, protocolos, equipamentos e segurança.",
    lessonsCount: 12 },
  { id:"aplicativos-computacionais", num:"04", name:"Aplicativos Computacionais",
    ...
    lessonsCount: 21 },
  { id:"ingles-tecnico", num:"05", name:"Inglês Técnico",
    desc:"Vocabulário e leitura técnica em inglês: hardware, software, redes, mensagens de erro, suporte e documentação.",
    lessonsCount: 8 },
  { id:"principios-de-hardware", num:"06", name:"Montagem e Manutenção de Computadores",
...
"aplicativos-computacionais": {
  ...
  "principios-de-hardware":{
    "aula-01":[{id:"Zd_zUQrmRcY",title:"O que é hardware e software",description:"Diferenças fundamentais.",platform:"YouTube",language:"Português"}],
    "aula-02":[{id:"saZKGM9kfgU",title:"Placa-mãe — O que é",description:"Introdução à placa-mãe.",platform:"YouTube",language:"Português"}],
    "aula-03":[{id:"dOEuqxm9Yqo",title:"Como funciona um processador",description:"Núcleos, threads e clock.",platform:"YouTube",language:"Português"}],
    "aula-04":[{id:"Z7QazYVo_k8",title:"O que é memória RAM",description:"Papel da RAM no computador.",platform:"YouTube",language:"Português"}],
    "aula-05":[{id:"7Y3hTY4vxWY",title:"HDD x SSD — Diferença",description:"Comparação entre HDD e SSD.",platform:"YouTube",language:"Português"}],
    "aula-10":[{id:"fh2MLbLOpvY",title:"Como montar um PC do zero",description:"Passo a passo de montagem.",platform:"YouTube",language:"Português"}]
  }
};
